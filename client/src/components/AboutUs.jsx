    ...
    return (
        <div className='h-full xl:h-90 px-28'>
            ...
            <div className='text-2xl font-bold text-justify leading-7'>
                ...
                <p>What We Offer:
                    <ul className='mt-2 pb-10 sm:pb-0'>
                        ...
                        <li>Contact Us: Have questions, suggestions, or feedback? Reach out to us through our "Contact Us" page. We value your input and are here to assist you on your culinary journey.</li>
                    </ul>    
                </p>
            </div>
        </div>
