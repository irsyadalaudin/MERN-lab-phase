...
const Login = () => {
    ...
    return (
        ...
        <div className='bg-yellow-600 h-90 flex items-center pl-10 lg:pl-28 overflow-hidden'>
            <div className='w-2/3 xl:w-1/2 text-center relative'>
                ...
                <form className='flex flex-col items-center px-28' style={{ display: showSignIn ? 'block' : 'none' }}>
                    <input className='placeholder-white focus:outline-none w-full xl:w-80 text-lg p-2 mb-2 bg-yellow-800 text-white rounded-lg' type='text' placeholder='Email / Username' />
                    <input className='placeholder-white focus:outline-none w-full xl:w-80 text-lg p-2 mb-2 bg-yellow-800 text-white rounded-lg' type='password' placeholder='Password' />
            ...
            {/* IMAGE */}
            <div className='w-1/3 xl:w-1/2 flex justify-center relative'>
                <img className='w-96 xl:w-96 2xl:w-93 sm:h-full xl:h-90 ml-72 lg:ml-0' src='https://i.postimg.cc/L6XC79m3/tofu-3.png' alt='tofu-login' style={{ objectFit: 'contain'}}/>
            </div>
        </div>
    )
}
