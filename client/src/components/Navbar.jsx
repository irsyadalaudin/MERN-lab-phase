...
const Navbar = ({ user, onLogout }) => {
    ...
    return (
        <>
            <nav className='bg-yellow-800 text-neutral-100 md:h-24 lg:h-14 py-3 md:py-5 lg:py-0 px-0 md:px-28 flex-col lg:flex-row flex justify-between items-center sticky top-0 hover:cursor-pointer'>
                <h1>
                    <Link to='/' onClick={scrollToTopHome}>
                        <img className='xl:mt-2 w-28' src='https://i.postimg.cc/VLD6CF6n/ayoo-masak-logo.png' alt='' />
                    </Link>
                </h1>
                <div className='mt-2 md:mt-0 flex gap-3 sm:gap-4 no-underline text-sm sm:text-base'>
